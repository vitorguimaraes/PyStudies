...
#É possível passar listas, tuplas e dicionários desempacotados como argumento de uma função
def func(a, b, c):
	print(a)
	print(b)
	print(c)
...
lista = ["Vitor", "Guimarães", 23]
tupla = "João", "Silva", 35
dicionario = {"nome": "Vitor", "sobrenome": "Guimarães", "idade": 20}
